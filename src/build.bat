...
set OUT_DIR=build
set OUT_EXE=main
set INCLUDES=/ID:\programming\gui\src\imgui /ID:\programming\gui\src\imgui\backends /ID:\programming\gui\src\libs\glfw\include
set LIBS=/LIBPATH:D:\programming\gui\src\libs\glfw\lib-vc2019 glfw3.lib opengl32.lib gdi32.lib shell32.lib
set SOURCES=d:\programming\gui\src\main.cpp d:\programming\gui\src\imgui\backends\imgui_impl_glfw.cpp d:\programming\gui\src\imgui\backends\imgui_impl_opengl3.cpp d:\programming\gui\src\imgui\imgui*.cpp
