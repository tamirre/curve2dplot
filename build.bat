...
set SOURCES=C:\programming\gui\src\main.cpp C:\programming\gui\src\imgui-docking\backends\imgui_impl_glfw.cpp C:\programming\gui\src\imgui-docking\backends\imgui_impl_opengl2.cpp C:\programming\gui\src\ImGuiFileDialog\ImGuiFileDialog*.cpp C:\programming\gui\src\implot\implot*.cpp  C:\programming\gui\src\imgui-docking\imgui*.cpp
